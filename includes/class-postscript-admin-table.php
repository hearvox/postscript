 ...
 *
 * Builds a table (using a WP_List_Table class).
 * https://codex.wordpress.org/Class_Reference/WP_List_Table
 *
 * Note: WP_List_Table class access is marked as private,
 * subject to change without warning in any future WordPress release.
 *
 * Based on plugin: Custom List Table Example
...
class Postscript_Script_Table extends WP_List_Table {
...
var $example_data = array(
    ...
    function prepare_items() {
        ...
        global $wp_scripts;
        $data = postscript_object_into_array( $wp_scripts->registered );
